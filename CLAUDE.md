...
│   ├── TUNING.md        # auto-tune strategy: safety-gated protocol, candidates, decision
│   ├── EXTENSIONS.md    # Phase 2: multi-antenna, multi-transceiver, SO2R
│   ├── DEV-SETUP.md     # VS Code + PlatformIO + Go development environment
...
7. **Vacuum-variable cap is protected by a defence-in-depth stack, not
   ...
   (P16) set for the direct-coupled load at install time via the HISU tool;
