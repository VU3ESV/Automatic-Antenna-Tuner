...
| Step pulse source      | **FlexPWM hardware** on the MCU (no loop-polled software stepping; see CLAUDE.md "Firmware portability rule" + `firmware/lib/flexpwm_stepper/src/flexpwm_stepper.h`) |
